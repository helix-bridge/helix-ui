...
export function convert(block_num, mmr_size, mmr_proof, leaf) {
  try {
    ...
    var ptr2 = passArray8ToWasm0(mmr_proof, wasm.__wbindgen_malloc);
    var len2 = WASM_VECTOR_LEN;
    var ptr3 = passArray8ToWasm0(leaf, wasm.__wbindgen_malloc);
    var len3 = WASM_VECTOR_LEN;
    wasm.convert(retptr, low0, high0, low1, high1, ptr2, len2, ptr3, len3);
