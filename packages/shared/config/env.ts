...
export const PARACHAIN_PARACHAIN_BACKING = (process.env.PARACHAIN_PARACHAIN_BACKING ||
  process.env.NEXT_PUBLIC_PARACHAIN_PARACHAIN_BACKING) as string;

export const PARACHAIN_PARACHAIN_ISSUING = (process.env.PARACHAIN_PARACHAIN_ISSUING ||
  process.env.NEXT_PUBLIC_PARACHAIN_PARACHAIN_ISSUING) as string;
