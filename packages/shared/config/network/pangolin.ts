...
export const pangolinConfig: DVMChainConfig = {
  ...
  tokens: [
    { name: 'PRING', precision: 9, bridges: ['helix'], type: 'native', logo: 'token-ring.svg' },
    { name: 'PKTON', precision: 9, bridges: ['helix'], type: 'native', logo: 'token-kton.svg' },
    { name: 'xORING', precision: 9, bridges: ['helix'], type: 'mapping', logo: 'token-ring.svg' },
    { name: 'xOKTON', precision: 9, bridges: ['helix'], type: 'mapping', logo: 'token-kton.svg' },
    { name: 'WPRING', precision: 9, bridges: ['helix'], type: 'mapping', logo: 'token-ring.svg' },
    { name: 'WPKTON', precision: 9, bridges: ['helix'], type: 'mapping', logo: 'token-kton.svg' },
  ],
  ss58Prefix: 42,
  specVersion: 28060,
