...
export const crabConfig: DVMChainConfig = {
  ...
  tokens: [
    { name: 'CRAB', precision: 9, bridges: ['helix'], type: 'native', logo: 'token-crab.svg' },
    { name: 'CKTON', precision: 9, bridges: ['helix'], type: 'native', logo: 'token-ckton.svg' },
    { name: 'xRING', precision: 9, bridges: ['helix'], type: 'mapping', logo: 'token-oring.svg' },
    { name: 'xKTON', precision: 9, bridges: ['helix'], type: 'mapping', logo: 'token-okton.svg' },
    { name: 'WCRAB', precision: 9, bridges: ['helix'], type: 'mapping', logo: 'token-wcrab.svg' },
    { name: 'WCKTON', precision: 9, bridges: ['helix'], type: 'mapping', logo: 'token-wckton.svg' },
  ],
