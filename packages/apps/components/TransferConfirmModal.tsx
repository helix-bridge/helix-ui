...
const Component = ({ visible, onCancel, onOk }: { visible: boolean; onCancel: () => void; onOk: () => void }) => (
  <BaseModal
    title='Transfer'
    visible={visible}
    footer={<Button className='w-full mx-2 mt-8 mb-4' size='large' type='primary' onClick={onOk}>Confirm Transfer</Button>}
    onCancel={onCancel}
  >
    <div className='flex flex-col'>
      <div className='relative'>
        <div className='flex items-center justify-between p-3 bg-gray-900 border border-gray-800'>
          ...
          <div className='flex flex-col items-end'>
            <Typography.Text strong type='danger'>-100.234</Typography.Text>
        ...
        <div className='flex items-center justify-between mt-3 p-3 bg-gray-900 border border-gray-800'>
          ...
          <div className='flex flex-col items-end'>
            <Typography.Text strong type='success'>+50.234</Typography.Text>
            <Typography.Text strong>RING</Typography.Text>
          </div>
        </div>
      ...
      <Alert type='warning' message='Please initiate a claim transaction of the Ethereum Network in the Transfer History to receive this token. And it needs to prepare some ETH as the gas fee to claim this token.' showIcon />
    </div>
  </BaseModal>
)
