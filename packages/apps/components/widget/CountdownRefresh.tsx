...
export const CountdownRefresh = forwardRef<SVGSVGElement, { isActive?: boolean; onIteration?: () => void }>(
  function RefreshIcon({ isActive, onIteration }, ref) {
    const circleRef = useRef<SVGCircleElement>(null);

    useEffect(() => {
      if (isActive && !circleRef.current?.classList.contains('refresh-countdown')) {
