...
const Component = ({ visible, onSelect, onCancel }: { visible: boolean; onCancel: () => void; onSelect: (value: unknown) => void }) => (
  <BaseModal
    ...
    <div className='max-h-96 overflow-auto mt-5'>
      <div className='flex flex-col space-y-2'>
        {(new Array(9)).fill(1).map((_, index) => (
          <div className='flex items-center justify-between border border-gray-800 bg-gray-900 py-3 px-2' key={index} onClick={() => onSelect(index)}>
