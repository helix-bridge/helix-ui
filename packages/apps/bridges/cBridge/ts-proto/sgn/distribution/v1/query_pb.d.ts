...
import * as sgn_distribution_v1_distribution_pb from './distribution_pb';
...
export class QueryValidatorOutstandingRewardsRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: QueryValidatorOutstandingRewardsRequest
  ): QueryValidatorOutstandingRewardsRequest.AsObject;
...
export class QueryValidatorOutstandingRewardsResponse extends jspb.Message {
  ...
  setRewards(
    value?: sgn_distribution_v1_distribution_pb.ValidatorOutstandingRewards
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryValidatorOutstandingRewardsResponse
  ): QueryValidatorOutstandingRewardsResponse.AsObject;
...
export class QueryValidatorCommissionRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryValidatorCommissionRequest
  ): QueryValidatorCommissionRequest.AsObject;
...
export class QueryValidatorCommissionResponse extends jspb.Message {
  ...
  setCommission(
    value?: sgn_distribution_v1_distribution_pb.ValidatorAccumulatedCommission
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryValidatorCommissionResponse
  ): QueryValidatorCommissionResponse.AsObject;
...
export class QueryDelegationRewardsResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegationRewardsResponse
  ): QueryDelegationRewardsResponse.AsObject;
...
export class QueryDelegationTotalRewardsRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegationTotalRewardsRequest
  ): QueryDelegationTotalRewardsRequest.AsObject;
...
export class QueryDelegationTotalRewardsResponse extends jspb.Message {
  ...
  setRewardsList(
    value: Array<sgn_distribution_v1_distribution_pb.DelegationDelegatorReward>
  ): QueryDelegationTotalRewardsResponse;
  clearRewardsList(): QueryDelegationTotalRewardsResponse;
  addRewards(
    value?: sgn_distribution_v1_distribution_pb.DelegationDelegatorReward,
    index?: number
  ): sgn_distribution_v1_distribution_pb.DelegationDelegatorReward;
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegationTotalRewardsResponse
  ): QueryDelegationTotalRewardsResponse.AsObject;
...
export class QueryDelegatorValidatorsRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegatorValidatorsRequest
  ): QueryDelegatorValidatorsRequest.AsObject;
...
export class QueryDelegatorValidatorsResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegatorValidatorsResponse
  ): QueryDelegatorValidatorsResponse.AsObject;
...
export class QueryDelegatorWithdrawAddressRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegatorWithdrawAddressRequest
  ): QueryDelegatorWithdrawAddressRequest.AsObject;
...
export class QueryDelegatorWithdrawAddressResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegatorWithdrawAddressResponse
  ): QueryDelegatorWithdrawAddressResponse.AsObject;
...
export class QueryStakingRewardInfoResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryStakingRewardInfoResponse
  ): QueryStakingRewardInfoResponse.AsObject;
...
export class QueryStakingRewardClaimInfoRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryStakingRewardClaimInfoRequest
  ): QueryStakingRewardClaimInfoRequest.AsObject;
  ...
  static deserializeBinaryFromReader(
    ...
    reader: jspb.BinaryReader
  ): QueryStakingRewardClaimInfoRequest;
}
...
export class QueryStakingRewardClaimInfoResponse extends jspb.Message {
  ...
  setRewardClaimInfo(
    value?: sgn_distribution_v1_distribution_pb.StakingRewardClaimInfo
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryStakingRewardClaimInfoResponse
  ): QueryStakingRewardClaimInfoResponse.AsObject;
...
export class QueryCBridgeFeeShareInfoRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryCBridgeFeeShareInfoRequest
  ): QueryCBridgeFeeShareInfoRequest.AsObject;
  ...
  static deserializeBinaryFromReader(
    ...
    reader: jspb.BinaryReader
  ): QueryCBridgeFeeShareInfoRequest;
}
...
export class QueryCBridgeFeeShareInfoResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryCBridgeFeeShareInfoResponse
  ): QueryCBridgeFeeShareInfoResponse.AsObject;
  ...
  static deserializeBinaryFromReader(
    ...
    reader: jspb.BinaryReader
  ): QueryCBridgeFeeShareInfoResponse;
}
...
export class QueryPegBridgeFeesInfoResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryPegBridgeFeesInfoResponse
  ): QueryPegBridgeFeesInfoResponse.AsObject;
  ...
  static deserializeBinaryFromReader(
    ...
    reader: jspb.BinaryReader
  ): QueryPegBridgeFeesInfoResponse;
}
