...
import wcrabABI from '../config/wcrab.json';
import { CrabDVMDarwiniaDVMBridgeConfig, IssuingPayload, RedeemPayload } from '../model';

export class CrabDVMInnerBridge extends Bridge<CrabDVMDarwiniaDVMBridgeConfig, DVMChainConfig, DVMChainConfig> {
  static readonly alias: string = 'CrabDVMInnerBridge';
