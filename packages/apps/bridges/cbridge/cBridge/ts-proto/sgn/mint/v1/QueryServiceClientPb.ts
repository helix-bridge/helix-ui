...
import * as sgn_mint_v1_query_pb from './query_pb';
...
export class QueryClient {
  ...
  ): Promise<sgn_mint_v1_query_pb.QueryParamsResponse>;

  params(
    request: sgn_mint_v1_query_pb.QueryParamsRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: sgn_mint_v1_query_pb.QueryParamsResponse) => void
  ): grpcWeb.ClientReadableStream<sgn_mint_v1_query_pb.QueryParamsResponse>;
  ...
  params(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/sgn.mint.v1.Query/Params',
        request,
        metadata || {},
  ...
  annualProvisions(
    request: sgn_mint_v1_query_pb.QueryAnnualProvisionsRequest,
    metadata: grpcWeb.Metadata | null
  ): Promise<sgn_mint_v1_query_pb.QueryAnnualProvisionsResponse>;

  annualProvisions(
    request: sgn_mint_v1_query_pb.QueryAnnualProvisionsRequest,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: sgn_mint_v1_query_pb.QueryAnnualProvisionsResponse) => void
  ): grpcWeb.ClientReadableStream<sgn_mint_v1_query_pb.QueryAnnualProvisionsResponse>;
  ...
  annualProvisions(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/sgn.mint.v1.Query/AnnualProvisions',
        request,
        metadata || {},
