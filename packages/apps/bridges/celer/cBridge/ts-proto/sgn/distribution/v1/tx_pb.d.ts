...
export class MsgWithdrawDelegatorRewardResponse extends jspb.Message {
  ...
  static toObject(
    ...
    msg: MsgWithdrawDelegatorRewardResponse
  ): MsgWithdrawDelegatorRewardResponse.AsObject;
...
export class MsgWithdrawValidatorCommissionResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgWithdrawValidatorCommissionResponse
  ): MsgWithdrawValidatorCommissionResponse.AsObject;
...
export class MsgClaimAllStakingRewardResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: MsgClaimAllStakingRewardResponse
  ): MsgClaimAllStakingRewardResponse.AsObject;
  ...
  static deserializeBinaryFromReader(
    ...
    reader: jspb.BinaryReader
  ): MsgClaimAllStakingRewardResponse;
}
