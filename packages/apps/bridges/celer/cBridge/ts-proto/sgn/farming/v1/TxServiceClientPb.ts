...
import * as sgn_farming_v1_tx_pb from './tx_pb';
...
export class MsgClient {
  ...
  ): Promise<sgn_farming_v1_tx_pb.MsgClaimRewardsResponse>;

  claimRewards(
    request: sgn_farming_v1_tx_pb.MsgClaimRewards,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: sgn_farming_v1_tx_pb.MsgClaimRewardsResponse) => void
  ): grpcWeb.ClientReadableStream<sgn_farming_v1_tx_pb.MsgClaimRewardsResponse>;
  ...
  claimRewards(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/sgn.farming.v1.Msg/ClaimRewards',
        request,
        metadata || {},
  ...
  claimAllRewards(
    request: sgn_farming_v1_tx_pb.MsgClaimAllRewards,
    metadata: grpcWeb.Metadata | null
  ): Promise<sgn_farming_v1_tx_pb.MsgClaimAllRewardsResponse>;

  claimAllRewards(
    request: sgn_farming_v1_tx_pb.MsgClaimAllRewards,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: sgn_farming_v1_tx_pb.MsgClaimAllRewardsResponse) => void
  ): grpcWeb.ClientReadableStream<sgn_farming_v1_tx_pb.MsgClaimAllRewardsResponse>;
  ...
  claimAllRewards(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/sgn.farming.v1.Msg/ClaimAllRewards',
        request,
        metadata || {},
  ...
  signRewards(
    request: sgn_farming_v1_tx_pb.MsgSignRewards,
    metadata: grpcWeb.Metadata | null
  ): Promise<sgn_farming_v1_tx_pb.MsgSignRewardsResponse>;

  signRewards(
    request: sgn_farming_v1_tx_pb.MsgSignRewards,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: sgn_farming_v1_tx_pb.MsgSignRewardsResponse) => void
  ): grpcWeb.ClientReadableStream<sgn_farming_v1_tx_pb.MsgSignRewardsResponse>;
  ...
  signRewards(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/sgn.farming.v1.Msg/SignRewards',
        request,
        metadata || {},
