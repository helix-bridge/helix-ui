...
import * as sgn_gov_v1_tx_pb from './tx_pb';
...
export class MsgClient {
  ...
  ): Promise<sgn_gov_v1_tx_pb.MsgSubmitProposalResponse>;

  submitProposal(
    request: sgn_gov_v1_tx_pb.MsgSubmitProposal,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: sgn_gov_v1_tx_pb.MsgSubmitProposalResponse) => void
  ): grpcWeb.ClientReadableStream<sgn_gov_v1_tx_pb.MsgSubmitProposalResponse>;
  ...
  submitProposal(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/sgn.gov.v1.Msg/SubmitProposal',
        request,
        metadata || {},
  ...
  vote(
    request: sgn_gov_v1_tx_pb.MsgVote,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: sgn_gov_v1_tx_pb.MsgVoteResponse) => void
  ): grpcWeb.ClientReadableStream<sgn_gov_v1_tx_pb.MsgVoteResponse>;
  ...
  vote(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/sgn.gov.v1.Msg/Vote',
        request,
        metadata || {},
        this.methodInfoVote,
        callback
  ...
  deposit(
    request: sgn_gov_v1_tx_pb.MsgDeposit,
    metadata: grpcWeb.Metadata | null
  ): Promise<sgn_gov_v1_tx_pb.MsgDepositResponse>;

  deposit(
    request: sgn_gov_v1_tx_pb.MsgDeposit,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError, response: sgn_gov_v1_tx_pb.MsgDepositResponse) => void
  ): grpcWeb.ClientReadableStream<sgn_gov_v1_tx_pb.MsgDepositResponse>;
  ...
  deposit(
    ...
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ + '/sgn.gov.v1.Msg/Deposit',
        request,
        metadata || {},
