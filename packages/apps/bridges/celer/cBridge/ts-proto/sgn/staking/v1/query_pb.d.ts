...
import * as sgn_staking_v1_staking_pb from './staking_pb';
...
export class QueryValidatorDelegationsRequest extends jspb.Message {
  ...
  static toObject(
    ...
    msg: QueryValidatorDelegationsRequest
  ): QueryValidatorDelegationsRequest.AsObject;
...
export class QueryValidatorDelegationsResponse extends jspb.Message {
  ...
  setDelegationResponsesList(
    value: Array<sgn_staking_v1_staking_pb.DelegationResponse>
  ): QueryValidatorDelegationsResponse;
  clearDelegationResponsesList(): QueryValidatorDelegationsResponse;
  addDelegationResponses(
    value?: sgn_staking_v1_staking_pb.DelegationResponse,
    index?: number
  ): sgn_staking_v1_staking_pb.DelegationResponse;
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryValidatorDelegationsResponse
  ): QueryValidatorDelegationsResponse.AsObject;
...
export class QueryDelegatorDelegationsRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegatorDelegationsRequest
  ): QueryDelegatorDelegationsRequest.AsObject;
...
export class QueryDelegatorDelegationsResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegatorDelegationsResponse
  ): QueryDelegatorDelegationsResponse.AsObject;
...
export class QueryDelegatorValidatorRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegatorValidatorRequest
  ): QueryDelegatorValidatorRequest.AsObject;
...
export class QueryDelegatorValidatorResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: QueryDelegatorValidatorResponse
  ): QueryDelegatorValidatorResponse.AsObject;
