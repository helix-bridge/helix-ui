...
const ethereumZksyncConfig: EthereumZksyncBridgeConfig = {
  contracts: {
...
export const ethereumZksyncLnBridge = new BridgeBase(ethereumConfig, zksyncConfig, ethereumZksyncConfig, {
