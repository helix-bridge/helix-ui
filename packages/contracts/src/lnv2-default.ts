...
const abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint112", name: "baseFee", type: "uint112" },
      { indexed: false, internalType: "uint8", name: "liquidityfeeRate", type: "uint8" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint64", name: "withdrawNonce", type: "uint64" },
    ],
    name: "MarginUpdated",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "address", name: "sourceToken", type: "address" },
      { indexed: false, internalType: "address", name: "targetToken", type: "address" },
      { indexed: false, internalType: "bytes32", name: "expectedTransferId", type: "bytes32" },
    ],
    name: "SlashRequest",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint112", name: "fee", type: "uint112" },
  ...
  },
  {
    inputs: [
      {
        components: [
          { internalType: "bytes32", name: "previousTransferId", type: "bytes32" },
      ...
      { internalType: "uint112", name: "_fee", type: "uint112" },
      { internalType: "uint112", name: "_penalty", type: "uint112" },
    ],
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_lastTransferId", type: "bytes32" },
      { internalType: "uint64", name: "_withdrawNonce", type: "uint64" },
  ...
  },
  {
    ...
    name: "lockInfos",
    outputs: [
      { internalType: "uint112", name: "fee", type: "uint112" },
      { internalType: "uint112", name: "penalty", type: "uint112" },
  ...
  },
  {
    ...
    name: "messagers",
    outputs: [
      { internalType: "address", name: "sendService", type: "address" },
      { internalType: "address", name: "receiveService", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_remoteChainId", type: "uint256" },
      { internalType: "bytes32", name: "_expectedTransferId", type: "bytes32" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_sourceToken", type: "address" },
      { internalType: "address", name: "_targetToken", type: "address" },
      { internalType: "uint112", name: "_baseFee", type: "uint112" },
      { internalType: "uint8", name: "_liquidityFeeRate", type: "uint8" },
    ],
    name: "setProviderFee",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_sourceToken", type: "address" },
      { internalType: "address", name: "_targetToken", type: "address" },
      { internalType: "uint112", name: "_protocolFee", type: "uint112" },
      { internalType: "uint112", name: "_penaltyLnCollateral", type: "uint112" },
      { internalType: "uint8", name: "_sourceDecimals", type: "uint8" },
      { internalType: "uint8", name: "_targetDecimals", type: "uint8" },
    ],
    name: "setTokenInfo",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "uint112", name: "baseFee", type: "uint112" },
          { internalType: "uint16", name: "liquidityFeeRate", type: "uint16" },
          { internalType: "uint64", name: "withdrawNonce", type: "uint64" },
          { internalType: "bool", name: "pause", type: "bool" },
        ],
        internalType: "struct LnDefaultBridgeSource.SourceProviderConfigure",
        name: "config",
        type: "tuple",
      },
      { internalType: "bytes32", name: "lastTransferId", type: "bytes32" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "slashReserveFund", type: "uint256" },
      { internalType: "uint64", name: "lastExpireFillTime", type: "uint64" },
      { internalType: "uint64", name: "withdrawNonce", type: "uint64" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    name: "tokenInfos",
    outputs: [
      { internalType: "uint112", name: "protocolFee", type: "uint112" },
      { internalType: "uint112", name: "penaltyLnCollateral", type: "uint112" },
      { internalType: "uint8", name: "sourceDecimals", type: "uint8" },
      { internalType: "uint8", name: "targetDecimals", type: "uint8" },
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint112", name: "totalFee", type: "uint112" },
          { internalType: "uint64", name: "withdrawNonce", type: "uint64" },
        ],
...
export const getLnV2DefaultContract: TFunction<typeof abi> = ({ address, publicClient, walletClient }) => {
