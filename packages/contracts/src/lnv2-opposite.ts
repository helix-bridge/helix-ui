...
const abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "address", name: "sourceToken", type: "address" },
      { indexed: false, internalType: "address", name: "targetToken", type: "address" },
      { indexed: false, internalType: "uint112", name: "margin", type: "uint112" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "bool", name: "hasSlashed", type: "bool" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "bytes32", name: "_latestSlashTransferId", type: "bytes32" },
      { internalType: "bytes32", name: "_transferId", type: "bytes32" },
      { internalType: "uint256", name: "_remoteChainId", type: "uint256" },
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "uint112", name: "margin", type: "uint112" },
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint112", name: "depositedMargin", type: "uint112" },
        ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_sourceToken", type: "address" },
      { internalType: "address", name: "_targetToken", type: "address" },
      { internalType: "uint112", name: "_margin", type: "uint112" },
...
export const getLnV2OppositeContract: TFunction<typeof abi> = ({ address, publicClient, walletClient }) => {
