      ...
      <div className={`flex h-10 w-full ${className}`}>
        {options
          ...
          .map(({ key, label, disabled }) => (
            <div
              key={key}
              className={`flex flex-1 items-center justify-center border-y border-r border-primary transition-colors duration-100 first:rounded-l-full first:border-l last:rounded-r-full ${
