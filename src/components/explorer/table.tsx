  ...
  return (
    <div className="space-y-3">
      ...
      <div className="w-full overflow-x-auto">
        <div className="min-w-[62rem] rounded-2xl bg-secondary p-2 lg:p-5">
          {/* Header */}
          <div
            ...
            {dataSource?.length ? (
              <div className="rounded-b-xl">
                {dataSource.map((row) => (
                  <div
                    className={`${
                      onRowClick ? "transition-colors hover:cursor-pointer hover:bg-background/50" : ""
                    } grid items-center gap-x-2 bg-background px-3 py-2 text-sm font-normal text-white last:rounded-b-xl`}
                    style={{ gridTemplateColumns: templateCols }}
