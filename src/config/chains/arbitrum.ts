...
export const arbitrumChain: ChainConfig = {
  ...
  tokens: [
    ...
    },
    {
      ...
      logo: "ring.svg",
      cross: [
        { target: { network: "ethereum", symbol: "RING" }, bridge: { category: "lnv2-opposite" } },
        { target: { network: "darwinia-dvm", symbol: "RING" }, bridge: { category: "lnv2-default" } },
        { target: { network: "polygon", symbol: "RING" }, bridge: { category: "lnv2-default" } },
      ],
    },
    {
      decimals: 6,
