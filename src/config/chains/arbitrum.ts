...
export const arbitrumChain: ChainConfig = {
  ...
  tokens: [
    ...
    },
    {
      ...
      logo: "ring.svg",
      cross: [
        { target: { network: "ethereum", symbol: "RING" }, bridge: { category: "lnbridge" } },
        { target: { network: "darwinia-dvm", symbol: "RING" }, bridge: { category: "lnbridge" } },
        { target: { network: "polygon", symbol: "RING" }, bridge: { category: "lnbridge" } },
      ],
    },
    {
      decimals: 6,
      ...
      cross: [
        ...
        { target: { network: "bsc", symbol: "USDT" }, bridge: { category: "lnbridge" } },
    ...
    },
    {
      ...
      cross: [
        ...
        { target: { network: "scroll", symbol: "USDC" }, bridge: { category: "lnbridge" } },
      ],
    },
  ],
