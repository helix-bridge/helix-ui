  ...
  tokens: [
    {
      ...
      logo: "ring.svg",
      cross: [
        { target: { network: "arbitrum", symbol: "RING" }, bridge: { category: "lnbridge" } },
        { target: { network: "crab-dvm", symbol: "xWRING" }, bridge: { category: "lnbridge" } },
        {
    ...
    },
    {
      ...
      logo: "crab.svg",
      cross: [
        { target: { network: "crab-dvm", symbol: "CRAB" }, bridge: { category: "lnbridge" } },
        {
