  ...
  tokens: [
    {
      ...
      logo: "ring.svg",
      cross: [
        { target: { network: "arbitrum", symbol: "RING" }, bridge: { category: "lnv2-default" } },
        { target: { network: "crab-dvm", symbol: "xWRING" }, bridge: { category: "lnv2-default" } },
        {
    ...
    },
    {
      ...
      logo: "crab.svg",
      cross: [
        { target: { network: "crab-dvm", symbol: "CRAB" }, bridge: { category: "lnv2-default" } },
        {
