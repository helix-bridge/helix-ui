const abi = [
  {
    inputs: [
      { internalType: "address[]", name: "_guards", type: "address[]" },
      { internalType: "uint256", name: "_threshold", type: "uint256" },
      { internalType: "uint256", name: "_maxUnclaimableTime", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "prevGuard", type: "address" },
      { internalType: "address", name: "guard", type: "address" },
      { internalType: "uint256", name: "_threshold", type: "uint256" },
      { internalType: "bytes[]", name: "signatures", type: "bytes[]" },
    ],
  ...
  {
    inputs: [{ internalType: "uint256", name: "_maxUnclaimableTime", type: "uint256" }],
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "prevGuard", type: "address" },
      { internalType: "address", name: "oldGuard", type: "address" },
      { internalType: "address", name: "newGuard", type: "address" },
      { internalType: "bytes[]", name: "signatures", type: "bytes[]" },
    ],
    name: "swapGuard",
    outputs: [],
